...
export const TableAtomsTemplatesContainer = styled.table<typeDefault>`
  ...
  tbody tr {
    ...
    max-width: ${
      props.$width?.$maxWidth ? `${props.$width.$maxWidth}rem` : `${100}%`
    };
    min-width: ${
      props.$width?.$minWidth ? `${props.$width.$minWidth}rem` : `${5}rem`
    };

    /*HEIGT */
    height: ${props.$height?.$height ? `${props.$height.$height}vh` : `auto`};
    max-height: ${
      props.$height?.$maxHeight ? `${props.$height.$maxHeight}rem` : `${100}%`
    };
    min-height: ${
      props.$height?.$minHeight ? `${props.$height.$minHeight}rem` : `${5}rem`
    };
    /*PADDING */
    ${
      props.$space?.$p &&
      css`
        padding: ${props.$space?.$p
          ? theme.space.p[props.$space?.$p]
          : false}rem;
      `
    }
    ${
    ...
    ${
      props.$space?.$m &&
      css`
        margin: ${props.$space?.$m
          ? theme.space.m[props.$space?.$m]
          : false}rem;
      `
    }
    ${
    ...
    ${
      props.$space?.$mx &&
      css`
        margin: ${props.$space.$mx
            ? theme.space.mx[props.$space.$mx]
            : false}rem
          0rem;
      `
    }
