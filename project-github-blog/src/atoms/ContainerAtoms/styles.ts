...
export const ContainerTemplatesContainer = styled(BoxAtoms)`
  ${({ theme, ...props }) => css`
    ...
    css`
      background-image: url(${props.$background_image?.url});
      background-attachment: ${props.$background_image?.backgroundAttachment};
      background-size: ${props.$background_image?.backgroundSize};
      background-position: ${props.$background_image?.backgroundPosition};
      /* clip-path: polygon(0% 0%, 100% 0%, 100% 50%, 0% 100%, 0% 0%);
      transform: translateX(${props.$background_image?.translate}0);
      transform: translateX(${props.$background_image?.translate}0); */
    ...
    css`
      border-top-left-radius: ${props.$border?.$radiusTopLeft.$width}px;
    `}
    ${props.$border?.$radiusTopRight &&
    css`
      border-top-right-radius: ${props.$border?.$radiusTopRight.$width}px;
    `}
    ${props.$border?.$radiusBottomLeft &&
    css`
      border-bottom-left-radius: ${props.$border?.$radiusBottomLeft.$width}px;
    `}
    ${props.$border?.$radiusBottomRight &&
    css`
      border-bottom-left-radius: ${props.$border?.$radiusBottomRight.$width}px;
    `}
    /* OVERFLOW */
    ${props.$overflow &&
    css`
