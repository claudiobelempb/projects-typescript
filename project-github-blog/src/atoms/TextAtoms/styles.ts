...
export const TextAtomsContainer = styled.p<typeDefault>`
  ${({ theme, ...props }) => css`
    ${props.$background &&
    css`
    ...
    ${props.$fonts?.$color &&
    css`
      color: ${theme.colors[props.$fonts.$color.$color]};
    `}

    ${props.$text?.$ellipsis &&
    css`
      -webkit-box-orient: vertical;
      -webkit-line-clamp: ${props.$text.$lines || 3};
      display: -webkit-box;
      overflow: hidden;
    `}
    ...
    css`
      text-transform: ${props.$text?.$textTransform};
    `}
    ${props.$text?.$textAlign &&
    css`
      text-align: ${props.$text?.$textAlign};
    ...
    css`
      border-top-left-radius: ${props.$border?.$radiusTopLeft || 8}px;
    `}
    ${props.$border?.$radiusTopRight &&
    css`
      border-top-right-radius: ${props.$border?.$radiusTopRight || 8}px;
    `}
    ${props.$border?.$radiusBottomLeft &&
    css`
      border-bottom-left-radius: ${props.$border?.$radiusBottomLeft || 8}px;
    `}
    ${props.$border?.$radiusBottomRight &&
    css`
      border-bottom-left-radius: ${props.$border?.$radiusBottomRight || 8}px;
    `}
  `}
`;
